        ...
        <div className="flex justify-center items-start mt-8 mb-8">
              ...
              <div className="w-1/2 text-left">
                <div className="mb-3">
                  <input 
                    ...
                    style={{ backgroundColor: 'rgba(25, 29, 36, 1)', borderRadius: '8px' }}
                  />
                </div>
                <div className="mb-3">
                  <textarea 
                    ...
                    style={{ backgroundColor: 'rgba(25, 29, 36, 1)', borderRadius: '8px', height: '200px' }}
                  />
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col items-center ml-8">
            <div className="flex flex-col justify-between items-start h-full">
              ...
              <div className="w-1 bg-[rgba(0,212,136,1)]" style={{ height: '64px', width: '2px', marginLeft: '15px' }}></div>
              <div className="flex items-center">
                <div className="h-8 w-8 border-2 border-[rgba(0,212,136,1)] rounded-full flex items-center justify-center" style={{ backgroundColor: 'transparent' }}>
                  <span className="text-xs text-white font-bold text-[rgba(0,212,136,1)]">2</span>
                </div>
                <span className="text-xs text-white ml-2">Crossing Bridge</span>
              </div>

              <div className="w-1 bg-gray-600" style={{ height: '64px', width: '2px', marginLeft: '15px' }}></div>
              <div className="flex items-center">
                <div className="h-8 w-8 border-2 border-gray-500 rounded-full flex items-center justify-center" style={{ backgroundColor: 'transparent' }}>
                  <span className="text-xs text-white font-bold text-gray-500">3</span>
                </div>
              ...
              <div className="flex items-center">
                <div className="h-8 w-8 border-2 border-gray-500 rounded-full flex items-center justify-center" style={{ backgroundColor: 'transparent' }}>
                  <span className="text-xs text-white font-bold text-gray-500">4</span>
                </div>
        ...
        <div className="flex justify-center items-start mt-8 mb-8">
          ...
          <div className="flex flex-col items-center ml-8">
            <div className="flex flex-col justify-between items-start h-full">
              ...
              <div className="flex items-center">
                <div className="h-8 w-8 border-2 border-[rgba(0,212,136,1)] rounded-full flex items-center justify-center" style={{ backgroundColor: 'transparent' }}>
                  <span className="text-xs text-white font-bold text-[rgba(0,212,136,1)]">3</span>
                </div>
                <span className="text-xs text-white ml-2">Approving Transfer</span>
              </div>
